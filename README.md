...
✅ 1. There are wet food options showing when log records if the favorite score is >= 20 /n
✅ 2. Displaying foods 🥫 list's favorite score that cat loves, the list can filter by All/Dry/Wet /n
